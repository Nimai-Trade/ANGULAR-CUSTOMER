...
@Component({
  selector: 'app-active-transaction-qoute',
  templateUrl: './active-transaction-qoute.component.html',
  styleUrls: ['./active-transaction-qoute.component.css']
})
export class ActiveTransactionQouteComponent implements OnInit {
