...
@Component({
  selector: 'app-transaction-detail-qoute',
  templateUrl: './transaction-detail-qoute.component.html',
  styleUrls: ['./transaction-detail-qoute.component.css']
})
export class TransactionDetailQouteComponent {
