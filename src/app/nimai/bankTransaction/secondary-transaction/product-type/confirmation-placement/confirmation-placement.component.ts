...
import { ActiveSecondTransactionComponent } from '../../active-second-transaction/active-second-transaction.component';
@Component({
  selector: 'app-confirmation-placement',
  templateUrl: './confirmation-placement.component.html',
  styleUrls: ['./confirmation-placement.component.css']
})
export class ConfirmationPlacementComponent implements OnInit {

  @ViewChild(ActiveTransactionComponent, { static: true }) activeTransaction: ActiveSecondTransactionComponent;
