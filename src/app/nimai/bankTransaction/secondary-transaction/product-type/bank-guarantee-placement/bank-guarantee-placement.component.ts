...
@Component({
  selector: 'app-bank-guarantee-placement',
  templateUrl: './bank-guarantee-placement.component.html',
  styleUrls: ['./bank-guarantee-placement.component.css']
})
export class BankGuaranteePlacementComponent implements OnInit {
