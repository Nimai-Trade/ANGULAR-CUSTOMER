...
@Component({
  selector: 'app-banker-placement',
  templateUrl: './banker-placement.component.html',
  styleUrls: ['./banker-placement.component.css']
})
export class BankerPlacementComponent implements OnInit {
