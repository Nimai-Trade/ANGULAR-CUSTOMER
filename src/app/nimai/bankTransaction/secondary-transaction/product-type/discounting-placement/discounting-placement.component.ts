...
@Component({
  selector: 'app-discounting-placement',
  templateUrl: './discounting-placement.component.html',
  styleUrls: ['./discounting-placement.component.css']
})
export class DiscountingPlacementComponent implements OnInit {
