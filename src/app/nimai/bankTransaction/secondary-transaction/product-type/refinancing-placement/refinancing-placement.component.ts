...
@Component({
  selector: 'app-refinancing-placement',
  templateUrl: './refinancing-placement.component.html',
  styleUrls: ['./refinancing-placement.component.css']
})
export class RefinancingPlacementComponent implements OnInit {
