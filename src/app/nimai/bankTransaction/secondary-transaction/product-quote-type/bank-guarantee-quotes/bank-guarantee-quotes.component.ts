...
@Component({
  selector: 'app-bank-guarantee-quotes',
  templateUrl: './bank-guarantee-quotes.component.html',
  styleUrls: ['./bank-guarantee-quotes.component.css']
})
export class BankGuaranteeQuotesComponent implements OnInit {
