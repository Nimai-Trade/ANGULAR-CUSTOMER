...
@Component({
  selector: 'app-confirmation-quotes',
  templateUrl: './confirmation-quotes.component.html',
  styleUrls: ['./confirmation-quotes.component.css']
})
export class ConfirmationQuotesComponent implements OnInit {
